...
describe ("multipleItems", function() {
  ...
  //   expect(items[3].name).to.equal(80);
  //   expect(items[4].name).to.equal(80);
  //   expect(items[5].name).to.equal(21);
  //   expect(items[6].name).to.equal(50);
  //   expect(items[7].name).to.equal(50);
  //   expect(items[8].name).to.equal(4);
  // });
